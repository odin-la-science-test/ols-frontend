  ...
  return (
    <CommandGroup heading={t('commandPalette.actions')}>
      ...
      <CommandItem
        ...
        onSelect={() => { eventBus.emit('platform:toggleComparison', undefined); close(); }}
        keywords={[t('commandPalette.keywords.compare'), t('commandPalette.keywords.comparison'), t('commandPalette.keywords.toggle')]}
      >
        {t('commandPalette.toggleComparison')}
      </CommandItem>
      <CommandItem
