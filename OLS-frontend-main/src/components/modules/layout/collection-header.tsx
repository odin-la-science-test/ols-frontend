...
import { Filter, GitCompareArrows, Search as SearchIcon, Trash2, X } from 'lucide-react';
...
export function SelectionModeBar({ selection, onOpenComparison, onBatchDelete }: SelectionModeBarProps) {
  const { t } = useTranslation();
