...
import { useDeleteContact, useRestoreContact, useToggleFavorite } from '../hooks';
  ...
  return (
    ...
    >
      ...
      <div className="flex items-start gap-3 mb-2">
        {/* Avatar */}
        <UserAvatar
          userId={contact.appUserId ?? undefined}
          avatarId={contact.appUserAvatarId}
          name={contactName}
          size="sm"
          showPresence={contact.isAppUser}
        />
