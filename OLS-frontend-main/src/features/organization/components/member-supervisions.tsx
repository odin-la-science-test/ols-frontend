...
function SupervisionList({
  ...
  userIdKey: 'superviseeId' | 'supervisorId';
  avatarIdKey: 'superviseeAvatarId' | 'supervisorAvatarId';
  ...
  return (
    <>
      <DetailSection title={`${t('organization.supervises')} (${supervisees.length})`} icon={GitBranch}>
        <SupervisionList items={supervisees} nameKey="superviseeName" userIdKey="superviseeId" avatarIdKey="superviseeAvatarId" onDelete={handleDelete} isDeleting={deleteSupervision.isPending} />
      ...
      <DetailSection title={`${t('organization.supervisedBy')} (${supervisors.length})`} icon={GitBranch}>
        <SupervisionList items={supervisors} nameKey="supervisorName" userIdKey="supervisorId" avatarIdKey="supervisorAvatarId" onDelete={handleDelete} isDeleting={deleteSupervision.isPending} />
