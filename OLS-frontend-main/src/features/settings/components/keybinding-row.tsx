  ...
  return (
    <div
      className={cn(
        ...
        isRecording
          ? 'neutral-border neutral-bg-subtle ring-1 neutral-ring'
          : hasConflict
    ...
    >
      ...
      {customized && !isRecording && !hasConflict && (
        <div className="w-1.5 h-1.5 rounded-full shrink-0 neutral-dot" />
      )}
        ...
        <div className="flex items-center gap-1.5">
          <button
            ...
            className={cn(
              ...
              customized
                ? 'neutral-border neutral-bg-subtle neutral-text'
