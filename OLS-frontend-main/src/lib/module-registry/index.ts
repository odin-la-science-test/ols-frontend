...
import { annotationsModule } from '@/features/annotations/definition';
import { studyCollectionsModule } from '@/features/study-collections/definition';
...
registry.register(annotationsModule);
registry.register(studyCollectionsModule);
