...
const DEFAULT_KEYBINDINGS: KeybindingEntry[] = [
  ...
  },
  {
    ...
    defaultCombo: { key: 'g', ctrlKey: true, shiftKey: false, altKey: false },
    userCombo: null,
  ...
  {
    id: 'historyUndo',
    defaultCombo: { key: 'z', ctrlKey: true, shiftKey: false, altKey: false },
    userCombo: null,
    labelKey: 'keybindings.actions.historyUndo',
    descriptionKey: 'keybindings.descriptions.historyUndo',
    category: 'navigation',
  },
  {
    id: 'historyRedo',
    defaultCombo: { key: 'y', ctrlKey: true, shiftKey: false, altKey: false },
    userCombo: null,
    labelKey: 'keybindings.actions.historyRedo',
    descriptionKey: 'keybindings.descriptions.historyRedo',
    category: 'navigation',
  },
  {
    id: 'quickCapture',
    defaultCombo: { key: 'n', ctrlKey: false, shiftKey: false, altKey: true },
    userCombo: null,
    labelKey: 'keybindings.actions.quickCapture',
    descriptionKey: 'keybindings.descriptions.quickCapture',
    category: 'navigation',
  },
  // Tabs 1-8
...
export const useKeybindingsStore = create<KeybindingsState>()(
  persist(
    ...
    }),
    {
      ...
      partialize: (state) => ({ bindings: state.bindings, _lastModified: state._lastModified }),
