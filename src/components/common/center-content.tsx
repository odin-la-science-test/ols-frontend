...
import { Breadcrumbs, TabBar } from '@/components/common';
...
export function CenterContent({
  ...
  const showToolRow = showBreadcrumbs || hasModuleToolbar || hasModuleFilters || hasToolbarSearch;
              ...
              <div style={{ height: '100%', display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
                ...
                {showChrome && showToolRow && (
                  <BreadcrumbsRow>
                    ...
                    <ToolbarSearch className={showBreadcrumbs ? 'ml-2' : ''} />
