...
// ═══════════════════════════════════════════════════════════════════════════
// TITLE BAR — Top-level bar: menus (left) + navigation (right)
//
// Left:  Home │ Atlas │ Lab │ Module │ View │ Help
// Right: [←][→] Breadcrumbs (NavigationBar embedded)
//
  ...
  return (
    <div
      ...
      className={cn(
        ...
        'surface-low border-b border-border/30',
    ...
    >
      ...
      {/* Navigation bar — back/forward + breadcrumbs (right side) */}
      <div className="w-px h-3.5 bg-border/30 mx-1" />
      <NavigationBar compact={isCompact} className="flex-1 min-w-0" />
