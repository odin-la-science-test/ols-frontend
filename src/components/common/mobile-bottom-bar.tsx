...
import { useTabsStore, useWorkspaceStore, type Tab, useCommandPaletteStore } from '@/stores';
      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className="fixed inset-0 z-[90] scrim"
            onClick={onClose}
          />
          {/* Sheet */}
          <motion.div
                ...
                tabs.map((tab) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      {isActive && (
                        <div
                          className={cn('w-2 h-2 rounded-full shrink-0', !accentColor && 'system-dot')}
...
export function MobileBottomBar() {
  ...
  return (
    <>
      ...
      <div className="lg:hidden fixed bottom-0 left-0 right-0 z-50 flex items-center border-t border-border surface-high px-2 pb-[env(safe-area-inset-bottom)]">
        <BottomBarButton
