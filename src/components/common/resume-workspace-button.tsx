    ...
    <AnimatePresence>
      {hasOpenTabs && (
        <motion.button
          ...
          whileTap={{ scale: 0.98 }}
          className={`group flex items-center gap-2 px-3 py-1.5 rounded-xl border border-border/40 bg-card/50 backdrop-blur-sm hover:bg-card/80 hover:border-border/70 transition-all duration-200 ${className ?? ''}`}
        >
