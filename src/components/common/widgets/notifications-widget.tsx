...
import { NOTIFICATION_TYPE_ICONS } from '@/features/notifications/notification-rendering';
              ...
              {recentNotifications.map((notif) => (
                ...
                >
                  <span className={cn(
                    ...
                    {(() => { const Icon = NOTIFICATION_TYPE_ICONS[notif.type] ?? Bell; return <Icon className="w-3.5 h-3.5" />; })()}
                  </span>
