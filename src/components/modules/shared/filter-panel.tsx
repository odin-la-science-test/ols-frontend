...
export function FilterPanel({
  ...
  return (
    <div data-tour="filter-panel" className={cn('space-y-0', className)}>
      {filters.map((filter, i) => (
        <div key={filter.key} className={cn('py-3 first:pt-0 last:pb-0', i > 0 && 'border-t border-foreground/25')}>
          <FilterControl
            filter={filter}
