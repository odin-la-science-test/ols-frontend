...
export const quickshareModule: ModuleDefinition = {
  ...
  settings: [{
    titleKey: 'quickshare.settings.title',
    fields: [
      { key: 'quickshare.defaultExpiration', type: 'select', labelKey: 'quickshare.settings.defaultExpiration', defaultValue: '24h', options: [
        { value: '1h', labelKey: 'quickshare.settings.expiration1h' },
        { value: '24h', labelKey: 'quickshare.settings.expiration24h' },
        { value: '7d', labelKey: 'quickshare.settings.expiration7d' },
        { value: 'never', labelKey: 'quickshare.settings.expirationNever' },
      ]},
      { key: 'quickshare.defaultMaxDownloads', type: 'number', labelKey: 'quickshare.settings.defaultMaxDownloads', defaultValue: 0, min: 0, max: 1000 },
    ],
  }],
};
