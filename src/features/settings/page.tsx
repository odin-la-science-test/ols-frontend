...
import { ModuleSettingsSection } from './components/module-settings-section';
...
export function SettingsPage() {
  ...
  const sections: SettingsSection[] = [
    { id: 'appearance', icon: Palette, labelKey: 'settingsPage.appearance', keywords: ['theme', 'dark', 'light', 'dim', 'onyx', 'thème', 'sombre', 'clair', 'preset', 'odin', 'rose', 'jade', 'ocean', 'amber', 'coral', 'slate', 'accent', 'accentuation', 'couleur'] },
    ...
    { id: 'data', icon: Database, labelKey: 'settingsPage.data', keywords: ['data', 'données', 'export', 'supprimer', 'delete', 'account', 'compte', 'gdpr', 'rgpd'] },
    ...(hasModuleSettings ? [{ id: 'module-settings', icon: Puzzle, labelKey: 'settingsPage.moduleSettings', keywords: ['module', 'plugin', 'extension', 'paramètres'] }] : []),
