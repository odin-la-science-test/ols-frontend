...
describe('profilesStore', () => {
  ...
  it('creates a new profile and sets it as active', () => {
    const snapshot = makeSnapshot({ themePreset: 'rose-dark' });
  ...
  it('updates profile snapshot', () => {
    ...
    const newSnapshot = makeSnapshot({ themePreset: 'jade-dark', density: 'compact' });
  ...
  it('exports and imports a profile', () => {
    const snapshot = makeSnapshot({ themePreset: 'coral-dark', density: 'comfortable' });
