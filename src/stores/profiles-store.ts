...
import { useSidebarModeStore } from './sidebar-mode-store';
...
export interface ProfileSnapshot {
  ...
  // Sidebar Modes
  primarySidebarMode?: 'dock' | 'overlay';
  secondarySidebarMode?: 'dock' | 'overlay';
  // Bottom Panel
...
export function captureSnapshot(): ProfileSnapshot {
  ...
  return {
    ...
    iconOnlyButtons: theme.iconOnlyButtons,
    accentedUI: theme.accentedUI,
...
export function applySnapshot(snapshot: ProfileSnapshot): void {
  ...
  try {
    ...
    ts.setIconOnlyButtons(snapshot.iconOnlyButtons);
    ts.setAccentedUI(snapshot.accentedUI);
